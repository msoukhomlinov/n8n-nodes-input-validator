...
export const stringProperties: INodeProperties[] = [
  ...
  ], default: 'E164', description: 'Choose the target format for rewriting the number.', displayOptions: { show: { validationType: ['string'], stringFormat: ['mobilePhone'], '/nodeMode': ['rewrite-phone'] } } },
  ...
  { displayName: 'Keep Extension', name: 'phoneRewriteKeepExtension', type: 'boolean', default: true, description: 'Preserve extensions when present (RFC3966 appends ;ext=1234).', displayOptions: { show: { validationType: ['string'], stringFormat: ['mobilePhone'], '/nodeMode': ['rewrite-phone'] } } },
  { displayName: 'Output Property', name: 'phoneRewriteOutputProperty', type: 'string', default: '', placeholder: 'e.g., customerPhoneE164', description: 'Where to write the formatted value (defaults to <name>Formatted).', displayOptions: { show: { validationType: ['string'], stringFormat: ['mobilePhone'], '/nodeMode': ['rewrite-phone'] } } },
  { displayName: 'Digit Separator', name: 'phoneRewriteSeparatorMode', type: 'options', options: [
    { name: 'Space', value: 'space' },
    { name: 'Hyphen', value: 'hyphen' },
    { name: 'Custom', value: 'custom' },
  ], default: 'space', description: 'Separator to use between digit groups (applies to INTERNATIONAL/NATIONAL).', displayOptions: { show: { validationType: ['string'], stringFormat: ['mobilePhone'], '/nodeMode': ['rewrite-phone'] } } },
  { displayName: 'Custom Separator', name: 'phoneRewriteSeparatorCustom', type: 'string', default: '', placeholder: 'e.g., \u00a0', description: 'Custom separator string when mode is Custom. Leave empty for space.', displayOptions: { show: { validationType: ['string'], stringFormat: ['mobilePhone'], phoneRewriteSeparatorMode: ['custom'] } } },
